const modernPirates = `
### [Modern Pirates](http://modern-pirates.s3-website.ap-northeast-2.amazonaws.com/)
...
const reactDrag = `
### [React UI playground](https://johnyworld.github.io/react-ui-playground/)
...
const conv250 = `
### [Conversation Staters 250](http://conv-250.s3-website.ap-northeast-2.amazonaws.com/)
...
const dowCross = `
### [DOW Crossroad Cards](http://dow-crossroad.s3-website.ap-northeast-2.amazonaws.com)
...
const johnyworld2019 = `
# [Johnyworld 2019](http://johnyworld.com)
...
const johnyworld2018 = `
### [Johnyworld 2018](http://johnyworld.com/2018)
